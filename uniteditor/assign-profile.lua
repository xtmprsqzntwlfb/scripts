...
For information about the json schema, please see the JSON_FORMAT.md file and
the "/hack/scripts/uniteditor/dwarf_profiles.json" file for other examples.
...
``-profile CARPENTER -reset PROFILE``
...
``-file /hack/military_profiles.json -profile ARCHER -reset ATTRIBUTES``
...
local scripts = {
    ATTRIBUTES = reqscript("uniteditor/assign-attributes"),
    SKILLS = reqscript("uniteditor/assign-skills"),
    PREFERENCES = reqscript("uniteditor/assign-preferences"),
    BELIEFS = reqscript("uniteditor/assign-beliefs"),
    GOALS = reqscript("uniteditor/assign-goals"),
    FACETS = reqscript("uniteditor/assign-facets"),
}

local default_filename = "/hack/scripts/uniteditor/dwarf_profiles.json"
