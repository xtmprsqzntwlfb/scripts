...
if args.showunitid or args.showpos then
 ...
 local pos = not(not args.x or not args.y or not args.z) and {x=tonumber(args.x),y=tonumber(args.y),z=tonumber(args.z)} or {x=df.global.cursor.x,y=df.global.cursor.y,z=df.global.cursor.z}
