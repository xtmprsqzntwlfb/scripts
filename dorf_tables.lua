...
local O = 0
job_distributions = {
    Thresholds      = { 7,  14, 21, 28, 30, 35, 42, 49, 56, 63, 70, 77, 138 }, --Don't touch unless you wanna recalculate the distributions,
    Miner           = { 2,  1,  O,  1,  O,  O,  2,  O,  O,  O,  1,  O,  3; cur = 0; max = nil }, --10
    _Grunt          = { O,  1,  1,  O,  O,  O,  1,  O,  2,  O,  2,  O,  7; cur = 0; max = nil }, --14
    Smelter         = { O,  O,  1,  O,  1,  O,  1,  O,  1,  O,  O,  O,  3; cur = 0; max = nil }, --7
    Blacksmith      = { O,  O,  O,  1,  O,  O,  1,  O,  1,  O,  O,  1,  2; cur = 0; max = nil }, --6

    Stoneworker     = { 1,  1,  1,  O,  1,  O,  O,  1,  O,  O,  2,  O,  3; cur = 0; max = nil }, --10
    Woodworker      = { 1,  O,  O,  1,  O,  O,  O,  1,  O,  O,  O,  O,  4; cur = 0; max = nil }, --7
    Architect       = { O,  1,  O,  O,  O,  1,  O,  1,  O,  1,  1,  O,  5; cur = 0; max = nil }, --10

    Farmer          = { 1,  O,  1,  1,  O,  O,  O,  O,  1,  O,  O,  O,  5; cur = 0; max = nil }, --10
    Clothier        = { O,  1,  O,  O,  O,  1,  1,  O,  1,  O,  O,  O,  4; cur = 0; max = nil }, --8
    Warden          = { 1,  O,  O,  1,  O,  O,  O,  O,  O,  1,  O,  O,  2; cur = 0; max = nil }, --5
    Hunter          = { O,  O,  O,  1,  O,  O,  O,  O,  1,  O,  O,  O,  2; cur = 0; max = nil }, --4
    Butcher         = { O,  O,  O,  1,  O,  O,  O,  1,  O,  O,  O,  O,  2; cur = 0; max = nil }, --4

    Artison         = { O,  1,  1,  O,  O,  O,  1,  2,  O,  O,  O,  6,  3; cur = 0; max = nil }, --14
    Doctor          = { O,  O,  1,  O,  O,  1,  O,  O,  O,  2,  O,  O,  4; cur = 0; max = nil }, --8
    Leader          = { 1,  O,  O,  O,  O,  1,  O,  O,  O,  1,  O,  O,  4; cur = 0; max = nil }, --7
    Trader          = { O,  1,  O,  O,  O,  O,  O,  1,  O,  O,  O,  O,  2; cur = 0; max = nil }, --4
    Engineer        = { O,  O,  1,  O,  O,  1,  O,  O,  O,  2,  O,  O,  6; cur = 0; max = nil }  --10
}
...
dorf_jobs = { --max -> max professions(ie. tertiary professions)
    ...
    Farmer = {
        req={'PLANTER'}, max={5},
        BREWER=0.5, FARMER=0.21, POTASH_MAKER=0.41, MILLER=0.21, MILKER=0.21, CHEESE_MAKER=0.21, SHEARER=0.29,
    ...
    Artison = {
        req={'CRAFTSMAN'}, max={7},
        ENGRAVER=0.8, WOODCRAFTER=0.6, STONECRAFTER=0.25, JEWELER=0.25, GEM_CUTTER=0.25, GEM_SETTER=0.25, BONE_CARVER=0.2, POTTER=0.2,
